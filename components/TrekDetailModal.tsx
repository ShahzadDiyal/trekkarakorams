        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 bg-slate-900 p-2">
          <div className="lg:col-span-2 h-64 sm:h-80 overflow-hidden relative">
            ...
            <div className="absolute bottom-4 left-4 right-4 text-white">
              ...
              <p className="text-[13px] sm:text-[16px] text-sky-300 mt-1 font-medium">
                {trek.tagline}
              </p>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="pb-3 border-b border-slate-200">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-[13px] text-slate-500 font-medium">/ person</span>
                </div>
              </div>
              ...
              <div className="py-4 space-y-3 text-[13px]">
                ...
                <div className="pt-2 border-t border-slate-200 flex justify-between font-bold text-slate-900">
                  ...
                  <span className="text-sky-700 text-[16px]">

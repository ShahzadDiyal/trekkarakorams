      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 space-y-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-50  pl-9 pr-3 py-2.5 text-[13px] sm:text-[16px] text-slate-900 focus:bg-white focus:border-sky-500 focus:outline-none"
            />
          </div>
        ...
        <div className="space-y-2">
            ...
            return (
              <div
                ...
                className={`transition-colors ${
                  isExpanded ? 'border border-sky-500 bg-sky-50/40' : 'bg-white hover:border-slate-300'
                }`}
              >
                <button
                ...
                {isExpanded && (
                  <div className="px-4 sm:px-5 pb-5 pt-1 text-[13px] sm:text-[16px] text-slate-700 leading-relaxed border-t border-sky-100/60">
                    {faq.answer}
                  </div>
                )}
              </div>
          ...
          {filteredFaqs.length === 0 && (
            <div className="p-8 text-center bg-slate-50  text-slate-600 text-[13px]">
        ...
        <div className="mt-8 p-4 bg-sky-50  flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
          <div>
            <div className="font-bold text-[13px] sm:text-[16px] text-slate-900">Have more specific questions?</div>
            <div className="text-[13px] text-slate-600">Our expedition managers in Skardu & Islamabad are on standby 24/7.</div>
          </div>
          <a
            href="https://wa.me/923009876543?text=Hi%2C%20I%20have%20a%20question%20about%20trekking%20in%20Pakistan"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-sky-600 hover:bg-sky-500 text-white font-bold text-[13px] px-4 py-2 flex items-center gap-1.5 shrink-0 transition-colors"
          >

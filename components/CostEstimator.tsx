    ...
    <section id="cost-estimator-section" className="py-14 bg-white border-b border-slate-200">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-8">
          <div className="flex items-center gap-1.5 text-[13px] font-bold uppercase tracking-wider text-sky-600 mb-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-7 bg-slate-50  p-5 sm:p-6 space-y-5">
            {/* 1. Select Expedition */}
            <div>
              <label className="block text-[13px] font-bold text-slate-800 uppercase tracking-wider mb-2">
                1. Select Trekking Route
              </label>
              <select
                value={selectedTrekId}
                onChange={(e) => setSelectedTrekId(e.target.value)}
                className="w-full bg-white border border-slate-300 p-2.5 text-[16px] font-semibold text-slate-900 focus:border-sky-500 focus:outline-none cursor-pointer"
              >
                {TREK_PACKAGES.map((t) => (
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-[13px] font-bold text-slate-800 uppercase tracking-wider">
                  2. Number of Trekkers
                </label>
                <span className="text-[13px] font-bold text-sky-700 bg-sky-100 px-2 py-0.5">
              ...
              <div className="flex flex-wrap gap-2">
                {[1, 2, 3, 4, 6, 8, 10, 12].map((num) => (
                  <button
                    ...
                    className={`px-3 py-1.5 text-[13px] font-bold border transition-colors cursor-pointer ${
                      groupSize === num
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-[13px] text-slate-900">Standard Expedition</span>
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-[13px] text-slate-900">VIP Glamping Tier</span>
          ...
          <div className="lg:col-span-5 bg-sky-950 text-white p-5 sm:p-6">
            ...
            <div className="py-4 space-y-2 text-[13px]">
              <div className="font-bold text-[16px] text-white">{selectedTrek.title}</div>
              ...
              <div className="pt-4 mt-3 border-t border-sky-800">
                <div className="text-[13px] text-sky-300 uppercase font-bold">Estimated Cost Per Person</div>
            ...
            <div className="mt-5 pt-4 border-t border-sky-900 space-y-2">
              <button
                ...
                className="w-full bg-sky-500 hover:bg-sky-400 text-slate-950 font-medium py-3 px-4 text-[13px] uppercase tracking-wider flex items-center justify-center gap-2 transition-colors cursor-pointer"
              >
              ...
              <a
                ...
                className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-2.5 px-4 text-[13px] flex items-center justify-center gap-2 transition-colors"
              >

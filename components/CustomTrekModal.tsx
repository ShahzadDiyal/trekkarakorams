  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/85 p-4 flex items-center justify-center">
      ...
      <div className="bg-white max-w-xl w-full max-h-[90vh] overflow-y-auto relative animate-fadeIn p-6 sm:p-8">
        ...
        <button
          onClick={onClose}
          className="sticky top-0 float-right p-1 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-[13px] z-10"
        ...
        {!submitted ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 p-2.5 text-[13px] text-slate-900 focus:border-sky-500 focus:outline-none"
                  />
                </div>
              </div>
          ...
          <div className="text-center py-8 space-y-4 clear-both">
            ...
            <p className="text-[13px] sm:text-[16px] text-slate-600 max-w-md mx-auto">
            ...
            <div className="p-4 bg-sky-50 text-[13px] text-slate-800 max-w-md mx-auto">

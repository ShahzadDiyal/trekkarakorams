          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white  p-6 space-y-3 text-[13px] text-slate-700">
              <div className="flex items-center gap-2 pb-2 border-b border-slate-200">
                ...
                <div>
                  <h3 className="font-bold text-[16px] text-slate-900">Skardu Basecamp Operations (HQ)</h3>
            ...
            <div className="bg-white  p-6 space-y-3 text-[13px] text-slate-700">
              <div className="flex items-center gap-2 pb-2 border-b border-slate-200">
                ...
                <div>
                  <h3 className="font-bold text-[16px] text-slate-900">Islamabad Liaison & Visa Office</h3>
            ...
            <div className="bg-sky-950 text-white  p-6 space-y-3 text-[13px]">
              <h3 className="font-bold text-sky-400 uppercase tracking-wider text-[13px]">

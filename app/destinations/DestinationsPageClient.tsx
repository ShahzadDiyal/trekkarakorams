          ...
          {DESTINATION_REGIONS.map((region) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-[13px] sm:text-[16px] font-bold truncate mt-0.5">{region.name.split('&')[0]}</div>
              </button>
            );
          })}
        </div>
        ...
        <div className="bg-white  overflow-hidden mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
            ...
            <div className="lg:col-span-7 p-6 sm:p-8 space-y-5">
              <div>
                <span className="text-[13px] font-bold text-sky-600 uppercase tracking-wider">
                  Region Profile
                </span>
                <p className="text-[16px] text-slate-700 leading-relaxed mt-2">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {activeRegion.keyPeaks.map((peak, i) => (
                      <span key={i} className="text-[13px] font-semibold bg-sky-50 text-sky-800 px-2.5 py-1 ">
                        {peak}
                      </span>
                    ))}
                  </div>
            ...
            {DESTINATION_REGIONS.map((r) => (
              ...
              >
                <div>
                  ...
                  <p className="text-[13px] text-slate-600 mt-2 line-clamp-3 leading-relaxed">{r.overview}</p>
                </div>

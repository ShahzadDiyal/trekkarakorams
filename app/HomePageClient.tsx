...
export const HomePageClient: React.FC = () => {
  ...
  return (
    <main className="flex-1">
      ...
      <section className="bg-slate-950 text-slate-200 py-3.5 border-y border-slate-800 text-[14px]">
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-3 sm:space-y-4">
              <span className="text-[11px] sm:text-[12px] md:text-[13px] font-bold uppercase tracking-widest text-sky-600">
              ...
              <p className="text-slate-700 text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed font-story">
                {BRAND_INFO.story[0]}
              </p>
              <p className="text-slate-600 text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed">
                {BRAND_INFO.story[1]}
              </p>
              ...
              <div className="pt-2 flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3">
                <button
                  ...
                  className="px-5 py-2.5 bg-sky-600 hover:bg-sky-700 text-white font-medium text-[12px] sm:text-[13px] uppercase tracking-wider transition-colors flex items-center justify-center gap-2 w-full sm:w-auto"
                >
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-[12px] sm:text-[13px] uppercase tracking-wider transition-colors w-full sm:w-auto text-center"
                >
            ...
            <div className="lg:col-span-5 bg-slate-900 p-5 sm:p-6 md:p-7 text-white relative mt-6 lg:mt-0">
              <div className="flex items-center gap-2 mb-3">
                <Gift className="w-5 h-5 text-amber-400 shrink-0" />
                <span className="text-[11px] sm:text-[12px] md:text-[13px] font-bold uppercase tracking-wider text-amber-400">
              ...
              <p className="text-[12px] sm:text-[13px] text-slate-300 mb-4 leading-relaxed">
                Be among the first explorers to journey with Trek Karakoram and receive lifetime privileges:
              </p>
              <ul className="space-y-2 text-[12px] sm:text-[13px] text-slate-200 mb-6">
              ...
              <button
                ...
                className="w-full py-2.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-[12px] sm:text-[13px] uppercase tracking-wider transition-colors flex items-center justify-center gap-1.5"
              >
      ...
      <section className="py-10 sm:py-12 md:py-14 bg-slate-50 border-b border-slate-200">
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-10">
            <span className="text-[11px] sm:text-[12px] md:text-[13px] font-bold uppercase tracking-widest text-sky-600">
              OUR GUIDING PRINCIPLES
            </span>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 tracking-tight mt-1">
              The 8 Core Values of Trek Karakoram
            </h2>
            <p className="text-[13px] sm:text-[14px] md:text-[16px] text-slate-600 mt-2 px-2 sm:px-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {BRAND_VALUES.map((val) => (
              <div
                key={val.number}
                className="bg-white p-4 sm:p-5 hover:border-sky-500 transition-colors flex flex-col justify-between border border-slate-100 hover:border-sky-500"
              >
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-[11px] sm:text-[12px] md:text-[13px] font-bold text-slate-400">0{val.number}</span>
                  </div>
                  <h3 className="text-[15px] sm:text-[16px] font-bold text-slate-900 tracking-tight mb-0.5">
                    {val.title}
                  </h3>
                  <div className="text-[10px] sm:text-[11px] font-bold text-sky-600 mb-2">
                    {val.subtitle}
                  </div>
      ...
      <section className="py-10 sm:py-12 md:py-14 bg-white border-b border-slate-200">
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-10">
            ...
            <p className="text-[13px] sm:text-[14px] md:text-[16px] text-slate-600 mt-2 font-story px-2 sm:px-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
            {AUDIENCE_PERSONAS.slice(0, 3).map((persona) => (
              <div key={persona.id} className="bg-slate-50 p-4 sm:p-5 md:p-6 flex flex-col justify-between border border-slate-100 hover:border-sky-200 transition-colors">
                <div>
                  <div className="inline-block bg-sky-100 text-sky-800 text-[9px] sm:text-[10px] font-bold px-2 py-0.5 uppercase tracking-wider mb-2">
                    {persona.title}
                  </div>
                  <h3 className="text-[15px] sm:text-[16px] font-bold text-slate-900 mb-2">
                    {persona.profile}
                  </h3>
                  <p className="text-[12px] sm:text-[13px] text-slate-600 mb-4 leading-relaxed">
                    <strong>Motivation:</strong> {persona.motivation}
                  </p>
                  <div className="bg-white p-3 sm:p-4 text-[12px] sm:text-[13px] text-slate-700 mb-4 border border-slate-200">
                    <span className="font-bold text-slate-900 block mb-0.5">How We Help:</span>
                    {persona.howWeHelp}
                  </div>
                </div>

                <div className="pt-3 border-t border-slate-200 text-[10px] sm:text-[11px] text-slate-500 italic font-story">

    ...
    <div className="bg-slate-50 min-h-screen py-10">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article className="bg-white  p-6 sm:p-10 mb-10">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 text-[13px] text-slate-500 mt-4 pb-6 border-b border-slate-200">
            ...
            <button
              onClick={handleShare}
              className="flex items-center gap-1 text-[13px] text-slate-700 hover:text-sky-600 bg-slate-100 px-3 py-1  transition-colors"
            >
          ...
          <div className="mt-8 p-5 bg-sky-50">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 bg-sky-600 hover:bg-sky-500 text-white font-bold text-[13px] px-4 py-2 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {relatedPosts.map((p) => (
              ...
              >
                ...
                <h4 className="font-bold text-[13px] sm:text-[16px] text-slate-900 mt-1 line-clamp-2">{p.title}</h4>

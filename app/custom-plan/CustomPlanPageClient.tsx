  ...
  return (
    <div className="min-h-screen bg-slate-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <button
          onClick={() => router.back()}
          className="inline-flex items-center gap-1 text-[16px] text-slate-600 hover:text-sky-600 mb-6 transition-colors"
        >
        ...
        <div className="bg-white p-6 sm:p-8 shadow-sm border border-slate-200">
          {!submitted ? (
            <>
              ...
              <p className="text-[13px] sm:text-[16px] text-slate-600 mt-1 mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 p-2.5 text-[16px] text-slate-900 focus:bg-white focus:border-sky-500 focus:outline-none"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                  <div className="sm:col-span-2">
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 border border-slate-300 p-2.5 text-[16px] text-slate-900 font-semibold focus:border-sky-500 focus:outline-none"
                    >
                      {TREK_PACKAGES.map((t) => (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 p-2.5 text-[16px] text-slate-900 focus:border-sky-500 focus:outline-none"
                    />
                  </div>
                </div>
            ...
            <div className="text-center py-12 space-y-4">
              ...
              <p className="text-[16px] sm:text-[16px] text-slate-600 max-w-md mx-auto">
              ...
              <div className="p-4 bg-sky-50 text-[16px] text-slate-800 max-w-md mx-auto">

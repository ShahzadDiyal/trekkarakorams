      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center justify-between p-3 bg-slate-50 hover:border-sky-400 cursor-pointer">
                  <div className="flex items-center gap-2.5">
                    ...
                    />
                    <div>
                      <div className="text-[13px] font-bold text-slate-900">Private Solo Tent Supplement</div>
                ...
                <label className="flex items-center justify-between p-3 bg-slate-50 hover:border-sky-400 cursor-pointer">
                  <div className="flex items-center gap-2.5">
                    ...
                    />
                    <div>
                      <div className="text-[13px] font-bold text-slate-900">Dedicated Personal Equipment Porter</div>
                ...
                <label className="flex items-center justify-between p-3 bg-slate-50 hover:border-sky-400 cursor-pointer">
                  <div className="flex items-center gap-2.5">
                    ...
                    />
                    <div>
                      <div className="text-[13px] font-bold text-slate-900">Dedicated Medical Oxygen Kit & Mask</div>
                ...
                <label className="flex items-center justify-between p-3 bg-slate-50 hover:border-sky-400 cursor-pointer">
                  <div className="flex items-center gap-2.5">
                    ...
                    />
                    <div>
                      <div className="text-[13px] font-bold text-slate-900">Starlink / Satellite WiFi Data Voucher</div>
                      <div className="text-[10px] text-slate-500">High-speed satellite messaging access at Concordia & Base Camp</div>
                    </div>
                  </div>
                  <span className="text-[13px] font-bold text-sky-700">+{formatPrice(90, currency)}</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 bg-sky-950 text-white p-6 sticky top-24 space-y-5">
            ...
            <div>
              <h3 className="text-[16px] font-bold text-white">{selectedTrek.title}</h3>
              <div className="text-[13px] text-sky-300 mt-0.5">
